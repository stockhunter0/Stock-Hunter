...
import 'supermarke_page_model.dart';
export 'supermarke_page_model.dart';

class SupermarkePageWidget extends StatefulWidget {
  const SupermarkePageWidget({super.key});

  @override
  State<SupermarkePageWidget> createState() => _SupermarkePageWidgetState();
}

class _SupermarkePageWidgetState extends State<SupermarkePageWidget>
    with TickerProviderStateMixin {
  late SupermarkePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SupermarkePageModel());
            ...
            child: Column(
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: Image.network(
                    'https://images.unsplash.com/photo-1604719312566-8912e9227c6a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw2fHxzdXBlcm1hcmtldHxlbnwwfHx8fDE3MTk2NzMwMTN8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                                              ...
                                                              fadeOutDuration:
                                                                  const Duration(
                                                                      milliseconds:
                                                                          500),
                                                              imageUrl:
                                                                  'https://choithrams-eg.com/wp-content/uploads/2024/03/Untitled3.png',
                                                              width: double
                                                                  .infinity,
                                                              fit: BoxFit
                                                                  .contain,
