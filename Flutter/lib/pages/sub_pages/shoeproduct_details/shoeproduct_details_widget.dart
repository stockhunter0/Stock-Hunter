...
import 'shoeproduct_details_model.dart';
export 'shoeproduct_details_model.dart';

class ShoeproductDetailsWidget extends StatefulWidget {
  const ShoeproductDetailsWidget({super.key});

  @override
  State<ShoeproductDetailsWidget> createState() =>
      _ShoeproductDetailsWidgetState();
}

class _ShoeproductDetailsWidgetState extends State<ShoeproductDetailsWidget>
    with TickerProviderStateMixin {
  late ShoeproductDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShoeproductDetailsModel());
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    ClipRRect(
                                                                      ...
                                                                      child: Image
                                                                          .network(
                                                                        'https://as1.ftcdn.net/v2/jpg/05/72/11/92/1000_F_572119262_9D0XFF7X37WqnNaIlqZtVdxxr0NpYJWK.jpg',
                                                                        width:
                                                                            70.0,
                                                                        height:
                                                                            70.0,
                                                                                    ...
                                                                                    child: Container(
                                                                                      ...
                                                                                      child: Padding(
                                                                                        ...
                                                                                        child: ClipRRect(
                                                                                          ...
                                                                                          child: Image.network(
                                                                                            'https://logopond.com/logos/d0c1836f24c831df2ab1b77bd91a70c0.png',
                                                                                            width: 70.0,
                                                                                            height: 70.0,
                                                                                            fit: BoxFit.cover,
                                                                                          ),
                                                                                    ...
                                                                                    child: Container(
                                                                                      ...
                                                                                      child: Padding(
                                                                                        ...
                                                                                        child: ClipRRect(
                                                                                          borderRadius: BorderRadius.circular(8.0),
                                                                                          child: Image.network(
                                                                                            'https://i.pinimg.com/originals/95/d0/28/95d028d025dce543f046ee4468f3fbcc.png',
                                                                                            width: 70.0,
                                                                                            height: 70.0,
                                                                                            fit: BoxFit.cover,
                                                                                          ),
